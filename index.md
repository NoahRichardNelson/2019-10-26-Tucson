...
instructor: ["Noah Nelson", "Sateesh Peri", "Kelsey	Gonzalez", "Xue Pan", "Travis Struck", "Upendra Devisetty", "Marnee Dearman", "Uwe Hilgert"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Drake	Asberry", "Brian	Bell", "Jennifer	Kadowaki", "David	LeBauer", "Torbet	McNeil", "Cesar Medina", "Cristian Palacios", "Adriana	Picoral", "Fernando Rios", "Austin	Rutherford", "Saren	Seeley"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
